...
namespace Phoenix.Mobile.PageModels.Common
{
    public class LaptopDetailPageModel : BasePageModel
    {
        ...
        //Thêm vô giỏ
        //
        public LaptopDetailPageModel(IProductSKUService productSKUService, IDialogService dialogService, IProductService productService, ICartItemService cartItemService, IRatingService ratingService, IWorkContext workContext)
        {
